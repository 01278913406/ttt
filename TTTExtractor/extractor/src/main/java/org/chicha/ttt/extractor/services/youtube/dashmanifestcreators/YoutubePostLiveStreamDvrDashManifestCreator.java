package org.chicha.ttt.extractor.services.youtube.dashmanifestcreators;

import static org.chicha.ttt.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.ALR_YES;
import static org.chicha.ttt.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.RN_0;
...
import static org.chicha.ttt.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.SQ_0;
import static org.chicha.ttt.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.buildAndCacheResult;
import static org.chicha.ttt.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateDocumentAndDoCommonElementsGeneration;
import static org.chicha.ttt.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateSegmentTemplateElement;
import static org.chicha.ttt.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateSegmentTimelineElement;
import static org.chicha.ttt.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.getInitializationResponse;
import static org.chicha.ttt.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.setAttribute;
import static org.chicha.ttt.extractor.utils.Utils.isNullOrEmpty;

import org.chicha.ttt.extractor.downloader.Response;
import org.chicha.ttt.extractor.services.youtube.DeliveryType;
import org.chicha.ttt.extractor.services.youtube.ItagItem;
import org.chicha.ttt.extractor.utils.ManifestCreatorCache;
